...
-- 工作目录（`cwd`）必须是仓库根目录 `c:\Notiz\ComputerScience`
...
```bash
# 在仓库根目录执行（示例：本项目结构）
typst compile "01-计算机基础/main.typ" "01-计算机基础/main.pdf" --root .

typst compile "02-编程语言/CPP/main.typ" "02-编程语言/CPP/main.pdf" --root .
```
